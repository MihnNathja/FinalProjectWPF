...
('6', N'Chuyên viên thiết kế đồ họa', N'Đại lý AdMax', N'Thỏa thuận', N'Cần Thơ, Việt Nam', N'', N'Thực hiện các chiến dịch quảng cáo sáng tạo, thiết kế đồ họa cho các sản phẩm và dịch vụ.', N'Kỹ năng thiết kế đồ họa, kiến thức về marketing.', N'Cơ hội phát triển nghề nghiệp.', N'Toàn thời gian'),
('7', N'Nhân viên phát triển ứng dụng di động', N'Creative Labs', N'Thỏa thuận', N'Đà Nẵng, Việt Nam', N'', N'Phát triển và duy trì các ứng dụng di động trên nền tảng Android và iOS.', N'Kỹ năng lập trình ứng dụng di động, đam mê công nghệ.', N'Cơ hội phát triển nghề nghiệp.', N'Toàn thời gian'),
('8', N'Chuyên viên phân tích tài chính', N'Financial Inc.', N'Thỏa thuận', N'Hà Nội, Việt Nam', N'', N'Phân tích dữ liệu tài chính, đưa ra các khuyến nghị về đầu tư và quản lý tài sản.', N'Kiến thức về tài chính, kỹ năng phân tích dữ liệu.', N'Các phúc lợi cạnh tranh.', N'Toàn thời gian'),
('9', N'Kỹ sư phần mềm Java', N'FPT SoftWare', N'Thỏa thuận', N'Thành phố Hồ Chí Minh, Việt Nam', N'Từ 3 năm kinh nghiệm trong phát triển phần mềm Java', N'Phát triển và triển khai các ứng dụng doanh nghiệp sử dụng Java.', N'Kỹ năng lập trình Java, kiến thức về phát triển phần mềm.', N'Mức lương và phúc lợi cạnh tranh.', N'Toàn thời gian'),
('10', N'Chuyên viên phân tích dữ liệu', N'FPT SoftWare', N'Thỏa thuận', N'Thành phố Hồ Chí Minh, Việt Nam', N'', N'Phân tích dữ liệu và đưa ra các giải pháp cải thiện hiệu suất kinh doanh.', N'Kiến thức về phân tích dữ liệu, kỹ năng sử dụng các công cụ phân tích.', N'Mức lương và phúc lợi cạnh tranh.', N'Toàn thời gian'),
('11', N'Chuyên viên hỗ trợ khách hàng', N'Financial Inc.', N'Thỏa thuận', N'Hà Nội, Việt Nam', N'', N'Hỗ trợ khách hàng giải quyết các vấn đề liên quan đến tài chính và dịch vụ.', N'Kỹ năng giao tiếp, kiến thức về tài chính.', N'Các phúc lợi cạnh tranh.', N'Toàn thời gian'),
('12', N'Nhân viên quản lý dự án', N'Doanh nghiệp toàn cầu', N'Thỏa thuận', N'Singapore', N'', N'Quản lý và triển khai các dự án thương mại điện tử và tiếp thị.', N'Kỹ năng quản lý dự án, kiến thức về thương mại điện tử.', N'Theo quy định.', N'Toàn thời gian');
